...
The lane with its shape is still too hard to comprehend a body of work by. The shape helps, but it gives a feeling of the whole rather than an understanding of it, and the canvas is what is needed next, since real knowledge of a tool being made is about to be worked in.
...
A piece of work in front of the reader, a step inside it, and on entering the step the level within; from there the reader goes back up to where they came from, or back up to whatever else leads there.
