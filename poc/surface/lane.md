...
The run says three things, and draws them apart. A reading the reader is inside, the body's root and every card they opened to get here, stands as a chip outlined in its branch's hue, the form the card they pressed had. A section of the reading they are in stands as plain faint text, since it is a place within one thing rather than a thing entered. And the rightmost is where the highlight stands, at full ink, whichever of the two it is. Each is lit in its colour when pointed at; a name above the scope is a press that scopes out to it, and one within the scope a press that goes there.
