...
![Two women bend over a small child between them, holding its hands as it steps; the figures are outlined in a few strokes of red chalk, the child's face the most drawn, the rest left open](.img/rembrandt-two-women-teaching-a-child-to-walk.jpg)\
...
The author's split for grading where effort goes next, held 2026-09-11.

Knowledge divides into what has to be told and what can be shown. The code is told, and by lab 10 it is nearly told. From there the gains move to what is shown: the surface the substrate is read through, and the interface it is worked in.
