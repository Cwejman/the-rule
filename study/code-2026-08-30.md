...
# The code, edition of 2026-08-30

*Not the law. This is the edition labs 01 to 05 were written under, kept beside them for that reason; it was ratified on the date it carries and superseded by the editions that followed. The living law is [the code](../code.md) at the arc's root, and the search around it is [the notebook](README.md).*
