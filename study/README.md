...
The fourth is the one that gets skipped. Its vocabulary is the code's own, measured, seen, reasoned or preferred, defined in [the code](10-comprehension/code.md); the grounds add nothing to it. A rule carrying no mark is not settled; it is unexamined.
