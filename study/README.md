...
The discriminating test — the first lab, [`03-importance-first/`](03-importance-first/prompt.md): the same corpus again, the same outcome request as encounters, importance-first without narrative as the arm — read cold against both baselines. Prompt drafted 2026-08-30 — **not ratified**; the author reviews it before the run starts.
