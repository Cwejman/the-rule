...
- One piece, saved as `output-2.md` beside this prompt file. If the depth the code asks for runs past what one document's headings carry under the proof of concept, an `output-2/` folder with `README.md` as its entry is allowed instead; say in your report why the document was not enough.
