...
The author's verdict, after the entry and every part: very large paragraphs and not much application of the gradient, a severe fault. The shape confirms it across the whole piece. No file has a subsection; the entry has eight sections and each part six to nine, every one a flat block of paragraphs. Of the parts' paragraphs, most run past 500 characters and the longest past 1,100; `substrate.md` has twenty-four of its thirty over the mark, `documentation.md` fourteen of nineteen. The whole piece is two levels deep, the entry's sections and the files' sections. That is lab 06's failure without the bullets: nested wins that never got their headings, and points fused into paragraphs the reader is force-fed. Seen, and the author's.
