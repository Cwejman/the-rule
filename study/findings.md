...
Three times now the evidence for a rule existed only in a session that was about to end. This is the finding that [the grounds](grounds.md#2-the-duty-is-per-session) make a standing duty.
