...
Three times now the evidence for a rule existed only in a session that was about to end. This is the finding that [§2.2](#22-the-duty-is-per-session) makes a standing duty.
