...
# The code, as ratified

*Ratified (author, 2026-08-30) and superseded since. The living law is [the code](../code.md) at the arc's root; this is the edition labs 01 to 05 were written under, kept beside them for that reason. The search around it lives in [the notebook](README.md).*
