...
A lab is one run of the search: a writer, a corpus, and an edition of the code, arranged so that what the run teaches can be told apart from what the writer happened to be good at. This says what a lab ships and the three rules that keep it honest. Read it before running one; the labs themselves, and the verdicts on them, are in [the notebook](README.md).
